...
public class NewJFrame extends javax.swing.JFrame {
    ...
    public NewJFrame() {
        ...
        admin.mediator.AddItem("Apple", 2.5f, 100);
        admin.mediator.AddItem("Oranges", 4.5f, 100);
        admin.mediator.AddItem("Mangos", 3.5f, 100);
        updateExecTable();
        updateUsrTable();
    ...
    private void initComponents() {
        ...
        txtfldbuy = new javax.swing.JTextField();
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(txtfldbuy, javax.swing.GroupLayout.PREFERRED_SIZE, 27, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
    ...
    private void addProdActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_addProdActionPerformed
        ...
        this.admin.mediator.AddItem(prodName.getText(),Float.parseFloat(prodPrice.getText()),Integer.parseInt(prodQuant.getText()));
        updateExecTable();
        updateUsrTable();
        prodName.setText("");
        prodPrice.setText("");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        this.admin.mediator.Buy(txtfldbuy.getText());
        txtfldbuy.setText("");
        updateExecTable();
        updateUsrTable();
    ...
    private javax.swing.JTextField txtfldbuy;
